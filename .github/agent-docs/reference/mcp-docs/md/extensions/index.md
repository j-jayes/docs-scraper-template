...
English
  ...
  * [English](https://modelcontextprotocol.info/docs/extensions/)
  * [简体中文](https://modelcontextprotocol.info/zh-cn/docs/extensions/)
  * [繁體中文](https://modelcontextprotocol.info/zh-tw/)
  * [한국어](https://modelcontextprotocol.info/ko/)
...
The lifecycle for official extensions is similar to a SEP, but delegated to extension repository maintainers:
  ...
  1. **Propose** : Author creates a SEP in the main MCP repository using the [standard SEP guidelines](https://modelcontextprotocol.info/community/sep-guidelines/) with type **Extensions Track**.
...
[Build an MCP Client (Core)](https://modelcontextprotocol.info/docs/development/build-client/ "Build an MCP Client \(Core\)")
