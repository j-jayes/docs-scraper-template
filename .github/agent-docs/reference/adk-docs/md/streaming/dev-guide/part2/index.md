...
[ ](https://github.com/google/adk-docs/edit/main/docs/streaming/dev-guide/part2.md "Edit this page on GitHub") [ ](./index.md "View this page as Markdown")
...
← [Previous: Part 1: Introduction to ADK Gemini Live API Toolkit](../part1/) | [Next: Part 3: Event Handling with run_live()](../part3/) →
