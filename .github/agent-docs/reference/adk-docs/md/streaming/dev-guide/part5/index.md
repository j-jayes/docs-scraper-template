...
Bidi-streaming (live) 
      * Bidi-streaming development guide series  Bidi-streaming development guide series 
        ...
        * Part 5. Audio, Images, and Video  [ Part 5. Audio, Images, and Video  ](./) Table of contents 
          * How to Use Audio 
            * Sending Audio Input 
...
[ ](https://github.com/google/adk-docs/edit/main/docs/streaming/dev-guide/part5.md "Edit this page") [ ](https://github.com/google/adk-docs/raw/main/docs/streaming/dev-guide/part5.md "View source of this page")
...
When you disable VAD (which is enabled by default), you must use manual activity signals (`ActivityStart`/`ActivityEnd`) to control conversation turns. See [Part 2: Activity Signals](../part2/#activity-signals) for details on manual turn control.
