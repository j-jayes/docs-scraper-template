...
[com.google.adk.web.websocket](../websocket/package-summary.html)
  ...
  * All Classes and InterfacesClassesRecord Classes

Class

Description

[AdkWebCorsConfig](AdkWebCorsConfig.html "class in com.google.adk.web.config")

Configuration class for setting up Cross-Origin Resource Sharing (CORS) in the ADK Web application.

[AdkWebCorsProperties](AdkWebCorsProperties.html "class in com.google.adk.web.config")

Properties for configuring CORS in ADK Web.

[AgentLoadingProperties](AgentLoadingProperties.html "class in com.google.adk.web.config")
