...
Skip navigation links
  ...
  * [Overview](../../../../index.html)
  * Class
  * [Use](class-use/VertexAiSearchTool.html)
...
Contents 
  ...
  4. Method Details
     ...
     8. dataStore()
     9. builder()
     10. processLlmRequest(LlmRequest.Builder, ToolContext)
...
public abstract class VertexAiSearchTool extends [BaseTool](BaseTool.html "class in com.google.adk.tools")
...
`static [VertexAiSearchTool.Builder](VertexAiSearchTool.Builder.html "class in com.google.adk.tools")`
...
public abstract [Optional](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Optional.html "class or interface in java.util")<[String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html "class or interface in java.lang")> dataStoreId()
...
public abstract [Optional](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Optional.html "class or interface in java.util")<[String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html "class or interface in java.lang")> searchEngineId()

    * ### filter

public abstract [Optional](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Optional.html "class or interface in java.util")<[String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html "class or interface in java.lang")> filter()

    * ### maxResults

public abstract [Optional](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Optional.html "class or interface in java.util")<[Integer](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Integer.html "class or interface in java.lang")> maxResults()
...
public abstract [Optional](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Optional.html "class or interface in java.util")<[String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html "class or interface in java.lang")> dataStore()

    * ### builder

public static [VertexAiSearchTool.Builder](VertexAiSearchTool.Builder.html "class in com.google.adk.tools") builder()
