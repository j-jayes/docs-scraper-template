...
Skip navigation links
  ...
  * [Overview](../../../../../../index.html)
  * Class
  * [Use](class-use/SpringAIErrorMapper.RetryStrategy.html)
...
[java.lang.Enum](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Enum.html "class in java.lang")<[SpringAIErrorMapper.RetryStrategy](SpringAIErrorMapper.RetryStrategy.html "enum class in com.google.adk.models.springai.error")>

com.google.adk.models.springai.error.SpringAIErrorMapper.RetryStrategy

All Implemented Interfaces:
    `[Serializable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/io/Serializable.html "interface in java.io"), [Comparable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Comparable.html "interface in java.lang")<[SpringAIErrorMapper.RetryStrategy](SpringAIErrorMapper.RetryStrategy.html "enum class in com.google.adk.models.springai.error")>, [Constable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/constant/Constable.html "interface in java.lang.constant")`
...
public static enum SpringAIErrorMapper.RetryStrategy extends [Enum](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Enum.html "class in java.lang")<[SpringAIErrorMapper.RetryStrategy](SpringAIErrorMapper.RetryStrategy.html "enum class in com.google.adk.models.springai.error")>
...
public static final [SpringAIErrorMapper.RetryStrategy](SpringAIErrorMapper.RetryStrategy.html "enum class in com.google.adk.models.springai.error") NO_RETRY

Do not retry - permanent failure

    * ### EXPONENTIAL_BACKOFF

public static final [SpringAIErrorMapper.RetryStrategy](SpringAIErrorMapper.RetryStrategy.html "enum class in com.google.adk.models.springai.error") EXPONENTIAL_BACKOFF

Retry with exponential backoff

    * ### FIXED_DELAY

public static final [SpringAIErrorMapper.RetryStrategy](SpringAIErrorMapper.RetryStrategy.html "enum class in com.google.adk.models.springai.error") FIXED_DELAY

Retry with fixed delay

    * ### IMMEDIATE_RETRY

public static final [SpringAIErrorMapper.RetryStrategy](SpringAIErrorMapper.RetryStrategy.html "enum class in com.google.adk.models.springai.error") IMMEDIATE_RETRY
...
public static [SpringAIErrorMapper.RetryStrategy](SpringAIErrorMapper.RetryStrategy.html "enum class in com.google.adk.models.springai.error")[] values()
...
public static [SpringAIErrorMapper.RetryStrategy](SpringAIErrorMapper.RetryStrategy.html "enum class in com.google.adk.models.springai.error") valueOf([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html "class in java.lang") name)
