...
public class SpringAIErrorMapper extends [Object](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Object.html "class or interface in java.lang")
...
`mapError([Throwable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Throwable.html "class or interface in java.lang") exception)`
...
public static [SpringAIErrorMapper.MappedError](SpringAIErrorMapper.MappedError.html "class in com.google.adk.models.springai.error") mapError([Throwable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Throwable.html "class or interface in java.lang") exception)
