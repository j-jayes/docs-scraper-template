...
Skip navigation links
  ...
  * [Overview](../../../../index.html)
  * Class
  * [Use](class-use/PlannerAgent.Builder.html)
...
LightDarkSystem Setting
  ...
  3. [Builder](PlannerAgent.Builder.html)
...
# Class PlannerAgent.Builder

[java.lang.Object](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Object.html "class in java.lang")

[com.google.adk.agents.BaseAgent.Builder](BaseAgent.Builder.html "class in com.google.adk.agents")<[PlannerAgent.Builder](PlannerAgent.Builder.html "class in com.google.adk.agents")>

com.google.adk.agents.PlannerAgent.Builder
...
public static class PlannerAgent.Builder extends [BaseAgent.Builder](BaseAgent.Builder.html "class in com.google.adk.agents")<[PlannerAgent.Builder](PlannerAgent.Builder.html "class in com.google.adk.agents")>
...
`planner([Planner](Planner.html "interface in com.google.adk.agents") planner)`
...
`protected [PlannerAgent.Builder](PlannerAgent.Builder.html "class in com.google.adk.agents")`
...
@CanIgnoreReturnValue public [PlannerAgent.Builder](PlannerAgent.Builder.html "class in com.google.adk.agents") planner([Planner](Planner.html "interface in com.google.adk.agents") planner)

    * ### maxIterations

@CanIgnoreReturnValue public [PlannerAgent.Builder](PlannerAgent.Builder.html "class in com.google.adk.agents") maxIterations(int maxIterations)

    * ### build

public [PlannerAgent](PlannerAgent.html "class in com.google.adk.agents") build()

Specified by:
    `[build](BaseAgent.Builder.html#build\(\))` in class `[BaseAgent.Builder](BaseAgent.Builder.html "class in com.google.adk.agents")<[PlannerAgent.Builder](PlannerAgent.Builder.html "class in com.google.adk.agents")>`
