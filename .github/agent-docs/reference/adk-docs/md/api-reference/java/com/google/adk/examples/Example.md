...
public abstract class Example extends [JsonBaseModel](../JsonBaseModel.html "class in com.google.adk")
...
public abstract [List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html "interface in java.util")<com.google.genai.types.Content> output()
