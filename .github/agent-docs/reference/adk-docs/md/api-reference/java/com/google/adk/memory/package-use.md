...
Packages that use [com.google.adk.memory](package-summary.html)
...
[BaseMemoryService](class-use/BaseMemoryService.html#com.google.adk.memory)

Base contract for memory services.

[MemoryEntry](class-use/MemoryEntry.html#com.google.adk.memory)

Represents one memory entry.

[MemoryEntry.Builder](class-use/MemoryEntry.Builder.html#com.google.adk.memory)

Builder for [`MemoryEntry`](MemoryEntry.html "class in com.google.adk.memory").

[SearchMemoryResponse](class-use/SearchMemoryResponse.html#com.google.adk.memory)

Represents the response from a memory search.

[SearchMemoryResponse.Builder](class-use/SearchMemoryResponse.Builder.html#com.google.adk.memory)
