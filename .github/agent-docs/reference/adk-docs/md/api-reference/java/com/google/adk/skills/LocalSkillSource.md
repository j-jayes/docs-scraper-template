...
Skip navigation links
  ...
  * [Overview](../../../../index.html)
  * Class
  * [Use](class-use/LocalSkillSource.html)
...
LightDarkSystem Setting
  ...
  2. [LocalSkillSource](LocalSkillSource.html)
...
Contents  
  ...
  5. Constructor Details
     1. LocalSkillSource(Path)
  6. Method Details
     1. listResources(String, String)
     2. listSkills()
     3. findResourcePath(String, String)
     4. findSkillMdPath(String)
     5. openChannel(Path)
...
[com.google.adk.skills.AbstractSkillSource](AbstractSkillSource.html "class in com.google.adk.skills")<[Path](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/nio/file/Path.html "interface in java.nio.file")>
...
public final class LocalSkillSource extends [AbstractSkillSource](AbstractSkillSource.html "class in com.google.adk.skills")<[Path](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/nio/file/Path.html "interface in java.nio.file")>
...
`LocalSkillSource([Path](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/nio/file/Path.html "interface in java.nio.file") skillsBasePath)`
...
`protected io.reactivex.rxjava3.core.Single<[Path](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/nio/file/Path.html "interface in java.nio.file")>`
...
`openChannel([Path](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/nio/file/Path.html "interface in java.nio.file") path)`
...
public LocalSkillSource([Path](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/nio/file/Path.html "interface in java.nio.file") skillsBasePath)
...
protected io.reactivex.rxjava3.core.Flowable<[AbstractSkillSource.SkillMdPath](AbstractSkillSource.SkillMdPath.html "class in com.google.adk.skills")<[Path](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/nio/file/Path.html "interface in java.nio.file")>> listSkills()
...
Specified by:
    `[listSkills](AbstractSkillSource.html#listSkills\(\))` in class `[AbstractSkillSource](AbstractSkillSource.html "class in com.google.adk.skills")<[Path](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/nio/file/Path.html "interface in java.nio.file")>`

    * ### findResourcePath

protected io.reactivex.rxjava3.core.Single<[Path](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/nio/file/Path.html "interface in java.nio.file")> findResourcePath([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html "class in java.lang") skillName, [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html "class in java.lang") resourcePath)
...
Specified by:
    `[findResourcePath](AbstractSkillSource.html#findResourcePath\(java.lang.String,java.lang.String\))` in class `[AbstractSkillSource](AbstractSkillSource.html "class in com.google.adk.skills")<[Path](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/nio/file/Path.html "interface in java.nio.file")>`

    * ### findSkillMdPath

protected io.reactivex.rxjava3.core.Single<[Path](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/nio/file/Path.html "interface in java.nio.file")> findSkillMdPath([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html "class in java.lang") skillName)
...
Specified by:
    `[findSkillMdPath](AbstractSkillSource.html#findSkillMdPath\(java.lang.String\))` in class `[AbstractSkillSource](AbstractSkillSource.html "class in com.google.adk.skills")<[Path](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/nio/file/Path.html "interface in java.nio.file")>`

    * ### openChannel

protected [ReadableByteChannel](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/nio/channels/ReadableByteChannel.html "interface in java.nio.channels") openChannel([Path](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/nio/file/Path.html "interface in java.nio.file") path) throws [IOException](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/io/IOException.html "class in java.io")
...
Specified by:
    `[openChannel](AbstractSkillSource.html#openChannel\(PathT\))` in class `[AbstractSkillSource](AbstractSkillSource.html "class in com.google.adk.skills")<[Path](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/nio/file/Path.html "interface in java.nio.file")>`
Throws:
