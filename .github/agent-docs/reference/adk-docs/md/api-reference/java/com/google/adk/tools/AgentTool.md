...
Contents  
  ...
  5. Constructor Details
     ...
     2. AgentTool(BaseAgent, boolean, boolean)
  6. Method Details
     1. fromConfig(BaseTool.ToolArgsConfig, String)
     2. create(BaseAgent, boolean, boolean)
     3. create(BaseAgent, boolean)
     4. create(BaseAgent)
     5. getAgent()
     6. declaration()
...
`AgentTool([BaseAgent](../agents/BaseAgent.html "class in com.google.adk.agents") agent, boolean skipSummarization, boolean includePlugins)`
...
`create([BaseAgent](../agents/BaseAgent.html "class in com.google.adk.agents") agent, boolean skipSummarization, boolean includePlugins)`
...
protected AgentTool([BaseAgent](../agents/BaseAgent.html "class in com.google.adk.agents") agent, boolean skipSummarization, boolean includePlugins)
...
public static [AgentTool](AgentTool.html "class in com.google.adk.tools") create([BaseAgent](../agents/BaseAgent.html "class in com.google.adk.agents") agent, boolean skipSummarization, boolean includePlugins)
...
public [BaseAgent](../agents/BaseAgent.html "class in com.google.adk.agents") getAgent()
