...
#### Hierarchy ([View Summary](../hierarchy.html#SequentialAgent))
  ...
  * Defined in [core/src/agents/sequential_agent.ts:19](https://github.com/google/adk-js/blob/6d1a56a15e0864ce1e83b259bc9964333503ff5a/core/src/agents/sequential_agent.ts#L19)
...
### constructor
  ...
  * new SequentialAgent(config: BaseAgentConfig): [SequentialAgent]()
...
Overrides [BaseAgent](BaseAgent.html).[runAsyncImpl](BaseAgent.html#runasyncimpl)
    ...
    * Defined in [core/src/agents/sequential_agent.ts:21](https://github.com/google/adk-js/blob/6d1a56a15e0864ce1e83b259bc9964333503ff5a/core/src/agents/sequential_agent.ts#L21)
...
Overrides [BaseAgent](BaseAgent.html).[runLiveImpl](BaseAgent.html#runliveimpl)
    ...
    * Defined in [core/src/agents/sequential_agent.ts:43](https://github.com/google/adk-js/blob/6d1a56a15e0864ce1e83b259bc9964333503ff5a/core/src/agents/sequential_agent.ts#L43)
