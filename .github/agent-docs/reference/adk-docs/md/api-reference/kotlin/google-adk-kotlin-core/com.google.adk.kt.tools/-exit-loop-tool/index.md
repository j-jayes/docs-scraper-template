...
[google-adk-kotlin-core](../../index.html)/[com.google.adk.kt.tools](../index.html)/ExitLoopTool

# ExitLoopTool

class [ExitLoopTool](index.html) : [BaseTool](../-base-tool/index.html)

A tool that allows an agent to exit a loop.

This tool sets the `escalate` and `skipSummarization` flags in the [ToolContext](../-tool-context/index.html), signaling that the agent should terminate its execution loop.

Members

## Constructors

[ExitLoopTool](-exit-loop-tool.html)
