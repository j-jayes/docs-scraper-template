...
[ ](https://github.com/google/adk-docs/edit/main/docs/runtime/runconfig.md "Edit this page on GitHub") [ ](./index.md "View this page as Markdown")
...
When using `runner.run_live()`, configure real-time behavior with these additional parameters:
  ...
  * `history_config`: Configures the exchange of history between the client and the server.
  * `translation_config`: Configures real-time speech-to-speech translation. Only translation models support it.
