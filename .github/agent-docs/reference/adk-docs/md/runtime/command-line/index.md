...
[ ](https://github.com/google/adk-docs/edit/main/docs/runtime/command-line.md "Edit this page") [ ](https://github.com/google/adk-docs/raw/main/docs/runtime/command-line.md "View source of this page")
...
Back to top  [ Previous  Web Interface  ](../web-interface/) [ Next  API Server  ](../api-server/)
