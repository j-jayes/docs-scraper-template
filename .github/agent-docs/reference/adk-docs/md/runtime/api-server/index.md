...
[ ](https://github.com/google/adk-docs/edit/main/docs/runtime/api-server.md "Edit this page on GitHub") [ ](https://github.com/google/adk-docs/raw/main/docs/runtime/api-server.md "View Markdown source")
...
ADK uses [Callbacks](../../callbacks/) to integrate with third-party observability tools. These integrations capture detailed traces of agent calls and interactions, which are crucial for understanding behavior, debugging issues, and evaluating performance.
