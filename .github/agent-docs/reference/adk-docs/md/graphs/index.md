...
[ ](https://github.com/google/adk-docs/edit/main/docs/graphs/index.md "Edit this page on GitHub") [ ](https://github.com/google/adk-docs/raw/main/docs/graphs/index.md "View Markdown source")
...
The following code sample shows how the workflow graph in Figure 2 could be translated into a graph-based agent using the **_Workflow_** class:
