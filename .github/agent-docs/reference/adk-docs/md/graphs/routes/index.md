...
[ ](https://github.com/google/adk-docs/edit/main/docs/graphs/routes.md "Edit this page on GitHub") [ ](./index.md "View this page as Markdown")
...
You can add **_LlmAgents_** to graph-based workflows. However, they must be configured for single-turn or task mode. For more information about agent modes, see [Build collaborative agent teams](/workflows/collaboration/#mode-configuration-and-behaviors).
