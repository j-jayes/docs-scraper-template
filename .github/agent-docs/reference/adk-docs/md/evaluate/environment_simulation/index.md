...
Evaluation 
      ...
      * Environment Simulation  [ Environment Simulation  ](./) Table of contents 
        * How it works 
        * Integration 
          * Using as a callback 
          * Using as a plugin 
...
[ ](https://github.com/google/adk-docs/edit/main/docs/evaluate/environment_simulation.md "Edit this page on GitHub") [ ](https://github.com/google/adk-docs/raw/main/docs/evaluate/environment_simulation.md "View Markdown source")
...
Back to top  [ Previous  User Simulation  ](../user-sim/) [ Next  Custom Metrics  ](../custom_metrics/)
