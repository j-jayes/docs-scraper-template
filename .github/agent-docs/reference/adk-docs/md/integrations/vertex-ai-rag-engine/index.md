...
[ ](https://github.com/google/adk-docs/edit/main/docs/integrations/vertex-ai-rag-engine.md "Edit this page on GitHub") [ ](https://github.com/google/adk-docs/raw/main/docs/integrations/vertex-ai-rag-engine.md "View Markdown source")
...
This tool can only be used **_by itself_** within an agent instance. For more information about this limitation and workarounds, see [Limitations for ADK tools](/adk-docs/tools/limitations/).
