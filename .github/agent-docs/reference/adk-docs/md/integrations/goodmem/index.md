...
[ ](https://github.com/google/adk-docs/edit/main/docs/integrations/goodmem.md "Edit this page on GitHub") [ ](https://github.com/google/adk-docs/raw/main/docs/integrations/goodmem.md "View Markdown source")
...
Plugin (Automatic memory)Tools (Agent-controlled memory)
