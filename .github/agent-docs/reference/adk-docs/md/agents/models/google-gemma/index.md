...
[ ](https://github.com/google/adk-docs/edit/main/docs/agents/models/google-gemma.md "Edit this page on GitHub") [ ](./index.md "View this page as Markdown")
...
To test out the capabilities of the Food Tour Agent, try pasting one of these prompts into the chat:
  ...
  * _"I want to do a ramen tour in Toronto. My budget is $60 for the day. Give me a walking route for the top 3 spots and tell me what I should order at each."_
  * _"I have this photo of a deep dish pizza [insert image URL]. I want to find the best places for this around Navy Pier in Chicago. Structure a walking tour and tell me what the must-have slice is at each stop."_
  * _"I'm in Downtown Austin looking for an authentic BBQ tour. Let's keep the budget under $100. Build a walking route between 3 highly-rated spots and give me insider tips on the best cuts of meat to get."_
