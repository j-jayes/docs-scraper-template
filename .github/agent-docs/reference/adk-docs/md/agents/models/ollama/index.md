...
Models for Agents 
      ...
      * Ollama  [ Ollama  ](./) Table of contents 
        * Get started 
        * Model choice 
        * Use OpenAI provider 
          * Debugging 
...
[ ](https://github.com/google/adk-docs/edit/main/docs/agents/models/ollama.md "Edit this page on GitHub") [ ](https://github.com/google/adk-docs/raw/main/docs/agents/models/ollama.md "View Markdown source")
...
Alternatively, you can use `openai` as the provider name. This approach requires setting the `OPENAI_API_BASE=http://localhost:11434/v1` and `OPENAI_API_KEY=anything` env variables instead of `OLLAMA_API_BASE`. Note that the `API_BASE` value has _`/v1`_ at the end.
...
Back to top  [ Previous  Apigee AI Gateway  ](../apigee/) [ Next  vLLM  ](../vllm/)
