...
Workflow agents 
      ...
      * [ Agent Config  ](../config/)
      * Models & Authentication  [ Models & Authentication  ](./) Table of contents 
...
[ ](https://github.com/google/adk-docs/edit/main/docs/agents/models.md "Edit this page") [ ](https://github.com/google/adk-docs/raw/main/docs/agents/models.md "View source of this page")

# Using Different Models with ADK¶

Supported in ADKPython v0.1.0Typescript v0.2.0Go v0.1.0Java v0.1.0

The Agent Development Kit (ADK) is designed for flexibility, allowing you to integrate various Large Language Models (LLMs) into your agents. While the setup for Google Gemini models is covered in the [Setup Foundation Models](../../get-started/installation/) guide, this page details how to leverage Gemini effectively and integrate other popular models, including those hosted externally or running locally.
...
You can enable the Interactions API by settting the `use_interactions_api=True` parameter in the Gemini model configuration, as shown in the following code snippet:
...
Back to top  [ Previous  Agent Config  ](../config/) [ Next  Tools for Agents  ](../../tools/)
