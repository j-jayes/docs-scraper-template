...
Models for Agents 
      ...
      * [ vLLM  ](../vllm/)
      * [ LiteLLM  ](../litellm/)
      * LiteRT-LM  [ LiteRT-LM  ](./) Table of contents 
        * Get started 
...
[ ](https://github.com/google/adk-docs/edit/main/docs/agents/models/litert-lm.md "Edit this page on GitHub") [ ](https://github.com/google/adk-docs/raw/main/docs/agents/models/litert-lm.md "View Markdown source")
...
Before you start the server, you need to download a model. You'll need a _Hugging Face_ user access token to download a LiteRT-LM model using `lit`. You can get a token for your _Hugging Face_ account [here](https://huggingface.co/settings/tokens).
