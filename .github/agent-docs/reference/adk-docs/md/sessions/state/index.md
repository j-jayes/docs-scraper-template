...
[ ](https://github.com/google/adk-docs/edit/main/docs/sessions/state.md "Edit this page") [ ](https://github.com/google/adk-docs/raw/main/docs/sessions/state.md "View source of this page")
...
If you want to both use an `InstructionProvider` _and_ inject state into your instructions, you can use the `inject_session_state` utility function.
...
Back to top  [ Previous  Rewind sessions  ](../rewind/) [ Next  Memory  ](../memory/)
