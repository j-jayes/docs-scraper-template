...
Sessions & Memory 
      * Sessions  Sessions 
        * [ Overview  ](../session/)
        * Rewind sessions  [ Rewind sessions  ](./) Table of contents 
          * Rewind a session 
          * How it works 
          * Limitations 
      * [ State  ](../state/)
...
[ ](https://github.com/google/adk-docs/edit/main/docs/sessions/rewind.md "Edit this page") [ ](https://github.com/google/adk-docs/raw/main/docs/sessions/rewind.md "View source of this page")
...
Back to top  [ Previous  Overview  ](../session/) [ Next  State  ](../state/)
