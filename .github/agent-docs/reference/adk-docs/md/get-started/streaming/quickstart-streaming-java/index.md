...
[ ](https://github.com/google/adk-docs/edit/main/docs/get-started/streaming/quickstart-streaming-java.md "Edit this page") [ ](https://github.com/google/adk-docs/raw/main/docs/get-started/streaming/quickstart-streaming-java.md "View source of this page")
...
Follow the instructions in [Installation](../../installation/) page to add `pom.xml` for using the ADK package.
...
Back to top  [ Previous  Python  ](../quickstart-streaming/) [ Next  Visual Builder  ](../../../visual-builder/)
