...
[ ](https://github.com/google/adk-docs/edit/main/docs/get-started/quickstart.md "Edit this page") [ ](https://github.com/google/adk-docs/raw/main/docs/get-started/quickstart.md "View source of this page")
...
For a detailed guide on authenticating to different models, see the [Authentication guide](../../agents/models/#google-ai-studio). This is a critical step to ensure your agent can make calls to the LLM service.
...
## 🛣️ Next steps¶
  ...
  * **Delve into advanced configuration:** Explore the [setup](../installation/) section for deeper dives into project structure, configuration, and other interfaces.
  * **Understand Core Concepts:** Learn about [agents concepts](../../agents/).



Back to top  [ Previous  Build your agent with ADK  ](../../tutorials/) [ Next  Agent team  ](../../tutorials/agent-team/)
