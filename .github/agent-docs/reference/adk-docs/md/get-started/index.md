...
[ ](https://github.com/google/adk-docs/edit/main/docs/get-started/index.md "Edit this page on GitHub") [ ](https://github.com/google/adk-docs/raw/main/docs/get-started/index.md "View Markdown source")
...
[ Start with TypeScript](typescript/)   





To get started with a technical overview check this [link](about/).

Back to top  [ Previous  Index  ](..) [ Next  Python  ](python/)
