...
Get Started 
      ...
      * [ Java  ](../java/)
      * [ Kotlin  ](../kotlin/)
      * Agents CLI  [ Agents CLI  ](./) Table of contents 
        * Installation 
        * Authenticate 
        * Build your agent 
        * Run your agent 
...
[ ](https://github.com/google/adk-docs/edit/main/docs/get-started/agents-cli.md "Edit this page on GitHub") [ ](./index.md "View this page as Markdown")
...
Now that you have Agents CLI installed and your first agent running, you can evaluate and deploy it with your coding agent using instructions like the following:
  ...
  * **_"Write evals for this agent and run them"_** to [evaluate your agent](https://google.github.io/agents-cli/guide/evaluation/) against the success criteria you set when you scoped it. Your coding agent grades the results, groups the failures by cause, and tunes the agent's instructions until it passes
  * **_"Deploy this to Cloud Run"_** to [deploy your agent](/deploy/agent-runtime/agents-cli/) to Agent Runtime, Cloud Run, or GKE.
  * **_"Set up observability infrastructure for my agent"_** to add prompt-response logging and content logs.
