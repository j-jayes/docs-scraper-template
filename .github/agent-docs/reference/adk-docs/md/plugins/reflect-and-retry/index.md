...
Plugins 
      * Reflect and retry  [ Reflect and retry  ](./) Table of contents 
...
[ ](https://github.com/google/adk-docs/edit/main/docs/plugins/reflect-and-retry.md "Edit this page on GitHub") [ ](https://github.com/google/adk-docs/raw/main/docs/plugins/reflect-and-retry.md "View Markdown source")

# Reflect and Retry Tool Plugin¶

Supported in ADKPython v1.16.0

The Reflect and Retry Tool plugin can help your agent recover from error responses from ADK [Tools](/adk-docs/tools-custom/) and automatically retry the tool request. This plugin intercepts tool failures, provides structured guidance to the AI model for reflection and correction, and retries the operation up to a configurable limit. This plugin can help you build more resilience into your agent workflows, including the following capabilities:
...
Back to top  [ Previous  Plugins  ](../) [ Next  Model Context Protocol (MCP)  ](../../mcp/)
