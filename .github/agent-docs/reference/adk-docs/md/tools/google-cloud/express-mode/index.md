...
[ ](https://github.com/google/adk-docs/edit/main/docs/tools/google-cloud/express-mode.md "Edit this page on GitHub") [ ](https://github.com/google/adk-docs/raw/main/docs/tools/google-cloud/express-mode.md "View Markdown source")
...
Google Cloud Vertex AI express mode provides a no-cost access tier for prototyping and development, allowing you to use Vertex AI services without creating a full Google Cloud Project. This service includes access to many powerful Vertex AI services, including:
  ...
  * Vertex AI SessionService
  * Vertex AI MemoryBankService
...
Back to top  [ Previous  Vertex AI Search  ](../vertex-ai-search/) [ Next  Third-Party Tools  ](../../third-party/)
