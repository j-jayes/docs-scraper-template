...
Gemini API tools 
        ...
        * Computer use  [ Computer use  ](./) Table of contents 
          * Setup 
          * Use the tool 
...
[ ](https://github.com/google/adk-docs/edit/main/docs/tools/gemini-api/computer-use.md "Edit this page on GitHub") [ ](https://github.com/google/adk-docs/raw/main/docs/tools/gemini-api/computer-use.md "View Markdown source")
...
Back to top  [ Previous  Code Execution  ](../code-execution/) [ Next  Google Search  ](../google-search/)
