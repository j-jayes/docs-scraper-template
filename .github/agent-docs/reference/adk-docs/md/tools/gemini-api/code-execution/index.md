...
[ ](https://github.com/google/adk-docs/edit/main/docs/tools/gemini-api/code-execution.md "Edit this page on GitHub") [ ](https://github.com/google/adk-docs/raw/main/docs/tools/gemini-api/code-execution.md "View Markdown source")
...
Back to top  [ Previous  Gemini API tools  ](../) [ Next  Computer use  ](../computer-use/)
