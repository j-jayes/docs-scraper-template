...
Agent Runtime 
        * Standard deployment  [ Standard deployment  ](./) Table of contents 
...
[ ](https://github.com/google/adk-docs/edit/main/docs/deploy/agent-runtime/deploy.md "Edit this page on GitHub") [ ](https://github.com/google/adk-docs/raw/main/docs/deploy/agent-runtime/deploy.md "View Markdown source")
...
Back to top  [ Previous  Deploy to Agent Runtime  ](../) [ Next  agents-cli  ](../agents-cli/)
