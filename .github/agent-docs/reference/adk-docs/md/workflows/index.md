...
Multi-Agent Workflows 
      * [ Collaborative workflows  ](collaboration/)
...
[ ](https://github.com/google/adk-docs/edit/main/docs/workflows/index.md "Edit this page on GitHub") [ ](./index.md "View this page as Markdown")
...
The following is a quick guide to the multiple methods for building workflows for your agent application with ADK:
  ...
  * [**Template workflows:**](/agents/workflow-agents/) These pre-built workflows are extended from **_BaseAgent_** and provide fixed execution logic structures including sequences, loops, and parallel execution.
