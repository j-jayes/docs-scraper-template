...
Bidi-streaming (live) 
    ...
    * Grounding  Grounding 
      * Understanding Google Search Grounding  [ Understanding Google Search Grounding  ](./) Table of contents 
        * What You'll Learn 
          * Additional resource 
...
[ ](https://github.com/google/adk-docs/edit/main/docs/grounding/google_search_grounding.md "Edit this page") [ ](https://github.com/google/adk-docs/raw/main/docs/grounding/google_search_grounding.md "View source of this page")
...
Back to top  [ Previous  Configuring Bidi-streaming behavior  ](../../streaming/configuration/) [ Next  Understanding Vertex AI Search Grounding  ](../vertex_ai_search_grounding/)
