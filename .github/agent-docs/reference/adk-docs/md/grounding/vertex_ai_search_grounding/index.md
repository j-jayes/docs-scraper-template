...
Bidi-streaming (live) 
    ...
    * Grounding  Grounding 
      * [ Understanding Google Search Grounding  ](../google_search_grounding/)
      * Understanding Vertex AI Search Grounding  [ Understanding Vertex AI Search Grounding  ](./) Table of contents 
        * What You'll Learn 
...
Table of contents 
  ...
  * Summary 
  ...
  2. [ Grounding  ](../google_search_grounding/)

[ ](https://github.com/google/adk-docs/edit/main/docs/grounding/vertex_ai_search_grounding.md "Edit this page on GitHub") [ ](https://github.com/google/adk-docs/raw/main/docs/grounding/vertex_ai_search_grounding.md "View Markdown source")
...
Back to top  [ Previous  Understanding Google Search Grounding  ](../google_search_grounding/) [ Next  Release Notes  ](../../release-notes/)
